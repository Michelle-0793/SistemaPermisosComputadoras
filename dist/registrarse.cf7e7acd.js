...
var _getUsuarios = require("../servicios/getUsuarios");
var _postUsuarios = require("../servicios/postUsuarios");
...
const btnIniciarSesión = document.getElementById("btnIniciarSesi\xf3n");
btnRegistrar.addEventListener("click", function() {
    ...
    async function crearUsuario() {
        ...
        if (cedulaExistente) mensaje.textContent = "\xa1La c\xe9dula ya est\xe1 registrada!";
        else {
            // Registrar el usuario si la cédula no existe
            const response = await (0, _postUsuarios.postUsers)(nombreUsuario, cedulaUsuario, emailUsuario, contrasenaUsuario, selectRol);
...
},{"../servicios/getUsuarios":"8a3An","../servicios/postUsuarios":"fWOLz"}],"8a3An":[function(require,module,exports) {
...
},{}],"fWOLz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "postUsers", ()=>postUsers);
async function postUsers(nombre, cedula, email, contrasena, rol) {
    try {
        const userData = {
            nombre,
            cedula,
